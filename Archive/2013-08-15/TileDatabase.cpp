...
} else if (g_strMapCountry == "dbES") {
	sprintf(m_filename, "%s\\%s\\%s_%s\\%d_%d_%d.db", g_strMapDatabaseFolder, g_strMapCountry, g_strMapScale, g_strMapFlavour, MyMap.m_nUTMZone, easting/100000, northing/100000);
} else {
