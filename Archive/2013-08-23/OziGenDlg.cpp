...
void COziGenDlg::OnBnClickedButtonGenerate()
{
	...
	||	(nDatabase == DB_Spain_Local  && !bOffline) 
	){
...
//		Kompass_LoadTiles(&g_db, minx, miny, maxx, maxy, bReplace, m_nScale);
	...
	} else if (nDatabase == DB_Spain_Local) {

//		Spain_LoadTiles(&g_db, minx, miny, maxx, maxy, bReplace, m_nScale);
		wmsLoadTiles(&g_db, minx, miny, maxx, maxy, bReplace, m_nScale);
	}
