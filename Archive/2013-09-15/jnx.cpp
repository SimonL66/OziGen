...
bool CreateJNXJpeg(JPEG_tile_list& tiles, long minx, long maxx, long miny, long maxy, CString mapname, long tileWidth, long tileHeight, DatabaseType nDatabase, int nDrawOrder, int nFlavour, int nCountry, int nScale)
{
...
bool DecMapJNX(CString strPath, CString strFile, CRect MyRect, long tileWidth, long tileHeight, DatabaseType nDatabase, int nDrawOrder, int nFlavour, int nCountry, int nScale)
{
