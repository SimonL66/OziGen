...
public:
	// e.g. for a 1-25K Tile; 4x4 tiles = 1km, each tile is 500x500 metres.
	CTileDatabase(long nDatum=MAP_DATUM_UK, int nMetresPerTile=500, int nMapScale=25000, int nPixelsPerTile=200); 
	~CTileDatabase();

	void InitDatabase(long northing, long easting, DWORD dataum=MAP_DATUM_UK);
