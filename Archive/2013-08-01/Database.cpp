...
//	Raster Map:
//	10K		25K		50K		100K	200K	250K			Country
	-1,		-1,		-1,		-1,		-1,		-1,			//	Austria
	250,	-1,		200,	-1,		-1,		-1,			//	Belgium
	250,	200,	200,	-1,		-1,		200,		//	Britain
	-1,		-1,		-1,		-1,		-1,		-1,			//	Eire
	-1,		-1,		-1,		-1,		-1,		-1,			//	France
	-1,		-1,		-1,		-1,		-1,		-1,			//	Germany
	-1,		-1,		-1,		-1,		-1,		-1,			//	Italy
	-1,		-1,		-1,		-1,		-1,		-1,			//	Luxembourg
	-1,		-1,		-1,		-1,		-1,		-1,			//	Netherlands
	-1,		-1,		-1,		-1,		-1,		-1,			//	Northern Ireland
...
//	10K		25K		50K		100K	200K	250K			Country
	-1,		-1,		-1,		-1,		-1,		-1,			//	Austria
	250,	-1,		1000,	-1,		-1,		-1,			//	Belgium
	250,	500,	1000,	-1,		-1,		5000,		//	Britain
	-1,		-1,		-1,		-1,		-1,		-1,			//	Eire
	-1,		-1,		-1,		-1,		-1,		-1,			//	France
	-1,		-1,		-1,		-1,		-1,		-1,			//	Germany
	-1,		-1,		-1,		-1,		-1,		-1,			//	Italy
...
//	10K		25K		50K		100K	200K	250K			Country
	-1,		-1,		-1,		-1,		-1,		-1,			//	Austria
	24,		-1,		24,		-1,		-1,		-1,			//	Belgium
	24,		 8,		 8,		-1,		-1,		 8,			//	Britain
	-1,		-1,		-1,		-1,		-1,		-1,			//	Eire
	-1,		-1,		-1,		-1,		-1,		-1,			//	France
	-1,		-1,		-1,		-1,		-1,		-1,			//	Germany
	-1,		-1,		-1,		-1,		-1,		-1,			//	Italy
...
//	10K		25K		50K		100K	200K	250K			Country
	-1,		-1,		-1,		-1,		-1,		-1,			//	Austria
	PNG,	-1,		PNG,	-1,		-1,		-1,			//	Belgium
	PNG,	PNG,	PNG,	-1,		-1,		PNG,		//	Britain
	-1,		-1,		-1,		-1,		-1,		-1,			//	Eire
	-1,		-1,		-1,		-1,		-1,		-1,			//	France
	-1,		-1,		-1,		-1,		-1,		-1,			//	Germany
	-1,		-1,		-1,		-1,		-1,		-1,			//	Italy
...
{
	CString str = Countries[nCountry];
	return str;
}
...
void MakeDatabaseFolders(int nFlavour, int nCountry, int nScale)
{
	...
	g_strMapCountry = Countries[nCountry];
	g_strMapScale = MapScales[nScale];

	strFolder.Format("%s\\%s", g_strMapDatabaseFolder, GetMapCountryText(nCountry));
	_mkdir(strFolder);

	strFolder.Format("%s\\%s\\%s_%s", g_strMapDatabaseFolder, GetMapCountryText(nCountry), GetMapScaleText(nScale), GetMapFlavourText(nFlavour));
	_mkdir(strFolder);
}
...
*/
	...
	case MAP_SCALE_VMD:
		...
		break;
	case MAP_SCALE_MS:
		dMetersPerPixel = 100.0;
		break;
	case MAP_SCALE_OV:
		dMetersPerPixel = 500.0;
		break;
