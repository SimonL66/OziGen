...
DoEvents();
if (wndProgress.m_Cancelled) return;
		}
	}
...
// GetStreetmap [extent1] [extent2]
// GetStreetmap [minx] [maxx] [miny] [maxy]
...
int main(int argc, char** argv)
{
	...
	if (argc == 2) {
		...
		printf(	"GetIGN {anquet file.pkg}\n"
				"GetIGN northing1 easting1 northing2 easting2\n"
				"GetIGN [-d]\n"
	...
	IGN_Create_PNG_JPR(strMapname, minx, miny, maxx, maxy);
