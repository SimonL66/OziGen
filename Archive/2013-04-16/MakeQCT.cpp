...
int IGN_read_bmp(long northing, long easting, MakeQCT_CTileDatabase * db, unsigned char * bm_ptr, long bitmap_width)
{
...
DoEvents();
			...
			IGN_read_bmp(y, x, &db, bitmap_memory + (x-minx)*width, mm_bitmap_width);
		}
		// create row of QCT
		long mmy;
