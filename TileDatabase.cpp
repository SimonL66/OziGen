...
} else if ((MyMap.GetProjection() == 2169) || (MyMap.GetProjection() == 3812) || (MyMap.GetProjection() == 21781) || (MyMap.GetProjection() == 3857) || (MyMap.GetProjection() == 900913)) {
	easting  *= m_scale;
	northing *= m_scale;
...
if ((MyMap.GetProjection() == 2169) || (MyMap.GetProjection() == 3812) || (MyMap.GetProjection() == 21781) || (MyMap.GetProjection() == 3857) || (MyMap.GetProjection() == 900913)) {
	easting  *= m_scale;
	northing *= m_scale;
}
	if (m_hFile == INVALID_HANDLE_VALUE)
